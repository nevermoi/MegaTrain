...
try:
    from .megatrain import MegaTrainEngine, MegaTrainEngineWithLMHead

    __all__ += ["MegaTrainEngine", "MegaTrainEngineWithLMHead"]
except ImportError:
    MegaTrainEngine = None
    MegaTrainEngineWithLMHead = None
